...
import 'package:easy_pel/pages/main/check/location/add_screen.dart';
import 'package:easy_pel/pages/main/check/location/detail_screen.dart';
...
class ViewScreenState extends State<ViewScreen> {
  ...
  Future<void> getData() async {
    ...
    Services().getApi('getLokasi', "pegawai_id=${pegawai_id}&periode=${periode}").then((val) {
      if (val['api_status'] == 1) {
        print(val['item']);
        setState(() {
          data = val['item'];
